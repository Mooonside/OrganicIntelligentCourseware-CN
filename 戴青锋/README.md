...
# 总结
该文章更多的是一种综述性质的讲解，主要分析和研究了复杂网络的构造以及其相关测度的计算和使用，但是其应用层面上还不够具体实际，例如从脑部的MRI图构建出大规模的连接矩阵用于分析脑部的功能或者诊断，这是需要进一步研究和实现的。课程报告见[生物智能课程报告_戴青锋_11621022.pdf](./生物智能课程报告_戴青锋_11621022.pdf)
